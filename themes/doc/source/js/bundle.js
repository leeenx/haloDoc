...
},{"./modules/api.js":2}],2:[function(require,module,exports){
/*API页面相关*/
...
Category = (function () {
	...
	_map = [];
	_genMap = function () {
		var _curr = document.getElementById('j_curr');
	...
	_bind = function () {
		...
		__onScroll();
		document.addEventListener('scroll', Util.saveFlow(__onScroll, 20));
	};
	init = function () {
		_genMap();
		_bind();
...
},{"./code_prettify.js":3,"./util":5}],3:[function(require,module,exports){
/*代码高亮*/
var Util = require('./util'),
...
},{"./google_code_prettify":4,"./util":5}],4:[function(require,module,exports){
! function () {
	var q = null;
